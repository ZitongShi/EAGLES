...
def parser_loader():
    parser = argparse.ArgumentParser(description='GCNexp')
    ...
    parser.add_argument('--num_clusters', type=int, default=5, help='')
    parser.add_argument('--lambda2', type=float, default=0.1, help='')
